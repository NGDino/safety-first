...
INSERT INTO post (title, post_text, user_id, business_id, safety_measures, mask_required, staff_mask, staff_gloves, contactless_payment, handsanitizer_provided, social_distancing, created_at, updated_at)
VALUES 
  ("Joes Pizza Place, a grea texperience", "this is a post for joes pizza place its great", 1, 1, 1, 0, 1, 0, 1, 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
